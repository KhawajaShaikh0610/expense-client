...
const ExpenseTracker = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (formData.type === "expense" && balanceTotal < formData.amount) {
        alert("You dont have enough income");
      } else {
        const response = await addTransaction({
          ...formData,
          userId: loggedInUser?.user?.id,
    ...
    <div className="w-full min-h-[90vh] mt-20 bg-gradient-to-br from-blue-50 to-indigo-100 p-4 md:p-8 overflow-y-auto">
      <div className="w-full space-y-6">
        ...
        <div className="text-center mb-16">
          <h1 className="text-3xl md:text-4xl font-bold text-indigo-800 mb-2 pt-12">
            Expense Tracker
          </h1>
          <p className="text-md md:text-lg text-indigo-600">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="bg-red-100 p-2 md:p-3 rounded-full">
                <svg
                  ...
                  className="h-6 md:h-8 w-6 md:w-8 text-red-600"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 border-l-8 border-blue-500">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-blue-100 p-2 md:p-3 rounded-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 md:h-8 w-6 md:w-8 text-blue-600"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 border-l-8 border-green-500">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-green-100 p-2 md:p-3 rounded-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 md:h-8 w-6 md:w-8 text-green-600"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 md:p-6">
          ...
          <form
            ...
            className="space-y-3 md:space-y-0 md:grid md:grid-cols-4 md:gap-3"
          >
            <div>
              <label
                htmlFor="description"
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 md:p-6 mb-6">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-4 md:mb-6">
            <h2 className="text-xl md:text-2xl font-semibold text-indigo-800 mb-2 md:mb-0">
              Transaction History
            </h2>
            <button
              onClick={generatePDF}
